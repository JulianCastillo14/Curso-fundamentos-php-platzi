...
<body>
    ...
    <?php
        if ($nivelCurso === "básico") {
            echo "<p>Este curso es para principiantes.</p>";
        } elseif ($nivelCurso === "intermedio") {
            echo "<p>Este curso es para usuarios con conocimientos previos.</p>";
        } elseif ($nivelCurso === "avanzado") {
            echo "<p>Este curso es para usuarios avanzados.</p>";
        } else {
            echo "<p>Nivel de curso no especificado.</p>";
        }
    ?>
</body>
</html>